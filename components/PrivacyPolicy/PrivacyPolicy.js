...
const PrivacyPolicy = () => {
  return (
    <section className="container pt-5">
      <h1 className="mt-5 text-primary display-4 mb-5 pt-5">Privacy Policy</h1>
      <p className="fs-5">
        This privacy policy will explain what information we collect online, why we collect it, and the choices we offer
        to you. This privacy policy (“Policy”) describes the data practices of Bleeding Edge Studio (“Bleeding Edge
        Studio”) and its subsidiaries (collectively, the “we”, or “Company”), covering its services under its control,
        including this website, any products, mobile applications, console or PC applications (collectively "Services").
        By using the Services, you are consenting to this Policy and the processing of your data in the manner provided
        in this Policy. If you do not agree with these terms, please do not use the Services. This Privacy Policy was
      ...
      <p className="fs-5">
        ...
        Act of 1998 (COPPA, http://www.coppa.org/coppa.htm), and Bleeding Edge Studio recognizes those rights.{" "}
      </p>
      ...
      <p className="fs-5">
        Bleeding Edge Studio admits advertisements (banners, interstitials.) from third parties ad networks. These
      ...
      <p className="fs-5">
        ...
        not under the control of Bleeding Edge Studio who is therefore not responsible for the availability or content
        of such external sites or services. But we always apply filters in Ad networks to show ads to users as per their
      ...
      <p className="fs-5">
        ...
        <a href="mailto:contact@bleeding edge.studio">contact@bleedingedge.studio</a>
      </p>
    </section>
  );
};

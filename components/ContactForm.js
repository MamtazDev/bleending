      ...
      <div className="row">
        <div className="col-12 col-lg-7 order-2 order-lg-1">
          ...
          <p className="fs-5 mb-5">
            ...
            Brief us of your requirements, and we’ll get started on it right
            away.
          </p>
          {messageFailed && (
          ...
          {reCaptachFailed && (
            <div className="alert alert-danger" role="alert">
              We're unable to verify whether you're human. Please reload and try
              again.
            </div>
          )}
          {!messageSent && (
            ...
            >
              <div className="row">
                ...
                <div className="col-12 col-lg-6">
                  ...
                  ></textarea>
                  <input
                    className="btn btn-primary px-5 text-white mt-4"
                    type="submit"
                    value="SEND"
                  />
                </div>
          ...
          {messageSent && (
            <div
              className="alert alert-success gradient-border p-3 text-white"
              role="alert"
            >

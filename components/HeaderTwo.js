...

    {
      ...
      subItems: [
        ...
        },
        {
          ...
          description: "Looking for a fun indoor game? Check out Carrom! This classic board game is perfect for players of all ages and skill levels. Get ready to hone your strategic thinking and precision shots!",
        },
        {
          title: "Archery Game",
          route: "/solution/archery-game-development",
          description: "Get ready to aim and shoot! Play our exciting Archery Game and experience the thrill of hitting the bullseye. Challenge your skills and compete with friends today.",
        },
        {
          title: "8 Ball Pool Game",
          route: "/solution/pool-8_ball-game-development",
          description: "Play the popular 8 Ball Pool game online and challenge your skills against players worldwide. Enjoy the classic gameplay and win big prizes. Start playing now!",
        },
        {
          title: "Real Money Game",
          route: "/solution/real-money-game-development",
          description: "Play exciting real money games and win big at our online gaming platform. Join now and experience the thrill of our top-rated games! Meta description: Play real money games and win big at our online gaming platform. Join now and experience the thrill of our top-rated games!",
        },
        {
          title: "Chess Game",
          route: "/solution/chess-game-development",
          description: "Experience the ultimate strategy game with Chess. Play online or against a computer and improve your skills. Join the millions of players worldwide!",
        },
        {
          title: "Car Simulation Game",
          route: "/solution/car-simulation-game-development",
          description: "Experience the thrill of driving in our car simulation game. With realistic graphics and physics, you'll feel like you're behind the wheel of your dream car. Play now!",
        },
        {
          title: "Shooting Game",
          route: "/solution/shooting-game-development",
          description: "Get ready to aim and fire with our thrilling shooting game! Test your skills and reflexes as you take on challenging levels and enemies. Play now for an adrenaline-pumping experience.",
        },
        {
          title: "Rummy Game",
          route: "/solution/rummy-game-development",
          description: "Enjoy the classic Rummy game online! Play with real players or against the computer. Get the ultimate gaming experience with our user-friendly interface. Join now!",
        },
        {
          title: "Poker Game",
          route: "/solution/poker-game-development",
          description: "Enjoy the thrill of the ultimate Poker Game! Join now and experience the excitement of high-stakes betting, skillful strategy, and big wins. Play with friends or join global tournaments.",
        },
        {
          title: "Tarneeb Game",
          route: "/solution/tarneeb-game-development",
          description: "Enjoy the popular Middle Eastern trick-taking card game of Tarneeb with friends and family. Learn the rules and strategies for success in this exciting game. Play now online!",
        },
        {
          title: "Hand Game",
          route: "/solution/hand-game-development",
          description: "Play the popular hand game and challenge your friends! Learn the rules, techniques, and strategies to win. Enjoy endless hours of fun with this classic game.",
        },
        {
          title: "Casino Game",
          route: "/solution/casino-game-development",
          description: "Looking for a thrilling casino game experience? Look no further than our selection of exciting games, featuring everything from classic slots to live dealer tables. Start playing now!",
        },
        {
          title: "Tower Defence Game",
          route: "/solution/tower-defense-game-development",
          description: "Protect your territory and strategize against enemy attacks in our Tower Defence Game. Play now and experience the thrill of defending your base!",
        },
        {
          title: "Callbreak Card Game",
          route: "/solution/callbreak-card-game-development",
          description: "Enjoy the popular Callbreak card game online! Play with friends or challenge new opponents. Learn the rules and strategy for this exciting trick-taking game.",
        },
        {
          title: "Stock Fantasy App",
          route: "/solution/stock-fantasy-app-development",
          description: "Experience the thrill of virtual trading with Stock Fantasy App. Learn, compete and win exciting rewards. Join now and become a pro trader!",
        },
        {
          title: "Fantasy Sports App",
          route: "/solution/fantasy-sports-app-development",
          description: "Looking for a fun way to engage with your favorite sports? Download our Fantasy Sports App today and get in on the action! Create your own teams and compete with other sports fans for the top spot on the leaderboard.",
        },
        {
          title: "Multi-gaming App",
          route: "/solution/multi-gaming-app-development",
          description: "Discover a world of endless gaming possibilities with our multi-gaming app. Enjoy a diverse range of games all in one place. Download now and start playing!",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          title: "About Us",
          route: "/about",
          description: "Learn more about our company and what sets us apart. Discover our mission, values, and commitment to providing exceptional products/services. Find out more.",
        },
        {
          title: "Our Work",
          route: "/work",
          description: "Discover what we do and how we can help you achieve your goals. Learn more about our work and the services we offer. Contact us today for more information.",
        },
        {
          title: "Our Process",
          route: "/process",
          description: "Discover the step-by-step approach to 'Our Process' and how it can help streamline your business. Learn how we can help you achieve your goals today.",
        },
        {
          title: "Key Infrastructure",
          route: "/infrastructure",
          description: "Discover the importance of key infrastructure in ensuring stability and security. Learn about critical systems and their role in modern society. Find out more now.",
        },
        {
